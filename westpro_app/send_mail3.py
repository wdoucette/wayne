...
def send_approved_mail(sender_address):
    # [START send_mail]
    mail.send_mail(sender="doucette.wayne@gmail.com", #sender_address,
                   to="Wayne Doucette <Doucette.Wayne@gmail.com>",
                   subject="Your account has been approved",
                   body="""Dear Wayne:

Your account has been approved.  You can now visit
http://www.google.ca and sign in using your Google Account to
access new features.
